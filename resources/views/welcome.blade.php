        ...
        <div class="container">
            <div class="hero-container">
                <div class="hero-text">
                    ...
                    <div class="buttons">
                        <button class="button white-button">ВСЕ УСЛУГИ</button>
                        <button class="button green-button">ВИДЕО О НАШЕМ ЦЕНТРЕ</button>
                    </div>
                </div>
                <div class="hero-image">
                    <img src="/media/nata.png" alt="Наталия Николаевна Бочарова">
                </div>
            </div>
        </div>
    </div>
